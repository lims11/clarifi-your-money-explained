       ...
       <Section className="py-12 sm:py-20 bg-white">
         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="grid md:grid-cols-2 gap-8 items-start">
             ...
             <div className="bg-[#E8E5F5] rounded-3xl p-8 sm:p-10">
               <h2 className="text-2xl sm:text-3xl font-extrabold leading-tight mb-4 text-[#1E1B4B]">
                 Your money, finally working for you.
               </h2>
               <p className="text-[#5B5BD6] text-base sm:text-lg leading-relaxed mb-6">
               ...
               <Link
                 to="/login?tab=signup"
                 className="inline-flex items-center gap-2 bg-[#1E1B4B] text-white font-semibold px-6 py-3 rounded-full hover:bg-[#5B5BD6] transition-all text-sm"
               >
